    ...
    stages {
        ...
        stage ('Publish') {
            steps {
                ...
                credentialsId: 'nexus-cred', groupId: 'com.vinaysdevopslab', nexusUrl: 'http://15.206.73.207:8081', nexusVersion: 'nexus3', protocol: 'http', repository: 'SnapShot', version: '0.0.4'
            }
        }
        //stage 4
        stage('Deploy') {
